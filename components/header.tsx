...
export default function Header() {
    ...
    return (
        <header 
            className="z-[999] relative opacity-90">
            <motion.div 
                className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border border-white border-opacity-40 bg-white/80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full dark:bg-slate-900/80 dark:border-black/40"
